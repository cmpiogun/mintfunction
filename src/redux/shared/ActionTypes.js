...
export const TWITTER_CHECK_SUCCESS = 'twitter_check_success';
...
export const CHECK_COLLECTIBLES_SUCCESS = 'check_collectibles_success';
export const GET_COLLECTIBLES_FAILED = 'get_collectibles_failed';